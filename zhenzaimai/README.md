...
只服务高桥镇及周边村庄的本地商品、商家与便民服务 MVP。村民可以找商品、找商家、找服务、发布个人闲置/自家农产品/全镇求购；商家可以申请入驻并在审核通过后管理商品；管理员可以审核商家和处理违规内容。
...
- `public/assets/images/gaoqiao-old-street.jpg`：首页主视觉
- `public/assets/images/gaoqiao-bridge.png`：高桥风貌区域
...
- 高桥镇中心：`28.4638705, 113.3307214`（OpenStreetMap Nominatim）
- 高桥老街风貌点
...
参考 `nginx.gaoqiao.example.conf`：

```nginx
server {
    listen 80;
    server_name gaoqiao.example.com;
